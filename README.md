...
<p align="center">
	<a href="https://github.com/qnscholar/zotero-if/releases"><img src="https://img.shields.io/badge/release-v1.0.0-orange?logo=github" alt="GitHub release" /></a>
...
1. 更新完 IF 后，请手动调出 rights（版权）列，才能在主界面看到 IF，点击【列标题】可以按照 IF 降（升）序排列；
